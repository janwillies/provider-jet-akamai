...
PROJECT_NAME := provider-jet-akamai
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/akamai/terraform-provider-akamai/releases/download/v1.10.0
...
IMAGES = provider-jet-akamai provider-jet-akamai-controller
