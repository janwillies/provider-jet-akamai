...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-jet-akamai/apis/property/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	...
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.Property_GroupVersionKind),
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), ws, s, cfg.Resources["akamai_property"])),
